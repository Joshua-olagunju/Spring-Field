            ...
            <div className="space-y-4">
              ...
              >
                <p className={`text-xs ${theme.text.secondary} mb-2`}>
                  📧 <strong>Recipient:</strong> {generatedOtp.recipient_name} ({generatedOtp.recipient_email})
                </p>
                <p className={`text-xs ${theme.text.secondary}`}>
                  ⏱️ <strong>Expires:</strong> {new Date(generatedOtp.expires_at).toLocaleString()}
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={isLoading || !recipientName.trim() || !recipientEmail.trim()}
